...
router
    ...
    var body, user, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                body = lodash_1.default.pick(req.body, ['email', 'password']);
                user = new user_model_1.User(body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
    ...
    .get('/me', authenticate_1.authenticate, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        res.send(req.user);
        return [2 /*return*/];
    });
    ...
    .delete('/me/token', authenticate_1.authenticate, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        try {
            user = req.user;
